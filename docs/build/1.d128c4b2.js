    ...
    1341: function(e, t, n) {
      e.exports = (function() {
        ...
        function elt(e, t, n, r) {
          ...
          if ((n && (o.className = n), r && (o.style.cssText = r), 'string' == typeof t))
        ...
        function isWordCharBasic(e) {
          return (
            /\w/.test(e) || (e > '' && (e.toUpperCase() != e.toLowerCase() || E.test(e)))
          );
        }
        ...
        function Display(e, t, r) {
          ...
          (this.input = r),
            ...
            (o.selectionDiv = elt('div', null, null, 'position: relative; z-index: 1')),
        ...
        function markedSpansBefore(e, t, n) {
          ...
          if (e)
            for (var o = 0; o < e.length; ++o) {
              ...
              if (
                s ||
                (i.from == t && 'bookmark' == a.type && (!n || !i.marker.insertLeft))
              ) {
                var l = null == i.to || (a.inclusiveRight ? i.to >= t : i.to > t);
                (r || (r = [])).push(new MarkedSpan(a, i.from, l ? null : i.to));
              }
            }
          return r;
        }
            ...
            (e.iter(t.line, n.line + 1, function(e) {
              if (e.markedSpans)
                for (var t = 0; t < e.markedSpans.length; ++t) {
                  ...
                  !n.readOnly || (r && -1 != indexOf(r, n)) || (r || (r = [])).push(n);
                }
            }),
            !r)
          )
          ...
          return function(s, l) {
            ...
            for (var F, B = [], z = 0; z < d; )
              if (i.test(p[z])) {
                ...
                for (var j = V; j < z; )
                  if (a.test(p[j])) {
                    V < j && B.splice(U, 0, new BidiSpan(1, V, j));
                    var G = j;
                    for (++j; j < z && a.test(p[j]); ++j);
                    B.splice(U, 0, new BidiSpan(2, G, j)), (V = j);
                  } else ++j;
            ...
            return (
              'ltr' == l &&
                ...
                1 == lst(B).level &&
                  (F = s.match(/\s+$/)) &&
                  ((lst(B).to -= F[0].length),
                  B.push(new BidiSpan(0, d - F[0].length, d)))),
              'rtl' == l ? B.reverse() : B
            );
          };
        })();
        ...
        function zeroWidthElement(e) {
          if (null == U) {
            var t = elt('span', '​');
            removeChildrenAndAdd(e, elt('span', [t, document.createTextNode('x')])),
        ...
        function hasBadBidiRects(e) {
          ...
          return (
            removeChildren(e), !(!n || n.left == n.right) && (j = r.right - n.right < 3)
          );
        }
        var _,
          K =
                ...
                (n.state = !0),
                  runMode(
                    ...
                    function(e, t) {
                      ...
                      if (t)
                        if (s.opaque) o.splice(n, l - n, e, 'overlay ' + t), (l = n + 2);
                        else
                          for (; n < l; n += 2) {
                            var i = o[n + 1];
                            o[n + 1] = (i ? i + ' ' : '') + 'overlay ' + t;
        ...
        function takeToken(e, t, n, r) {
          ...
          for (r && (s = []); (r || u.pos < t.ch) && !u.eol(); )
            (u.start = u.pos),
              ...
              r && s.push(new ne(u, o, copyState(i.mode, c.state)));
          return r ? s : new ne(u, o, c.state);
        }
        ...
        function runMode(e, t, n, r, o, i, a) {
          ...
          for ('' == t && extractLineClasses(callBlankLine(n, r.state), i); !d.eol(); ) {
            if (
        ...
        function findStartLine(e, t, n) {
          for (
            ...
            var l = getLine(i, s - 1),
              c = l.stateAfter;
            if (c && (!n || s + (c instanceof ee ? c.lookAhead : 0) <= i.modeFrontier))
              return s;
        ...
        function buildLineContent(e, t) {
          ...
          for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
            ...
            (r.pos = 0),
              ...
              (r.map = []);
            var s = t != e.display.externalMeasured && lineNo(i);
            insertLineContent(i, r, getLineStyles(e, i, s)),
              i.styleClasses &&
                (i.styleClasses.bgClass &&
                  (r.bgClass = joinClasses(i.styleClasses.bgClass, r.bgClass || '')),
              ...
              for (var h = 0; ; ) {
                ...
                if ('\t' == f[0]) {
                  var y = e.cm.options.tabSize,
                    b = y - (e.col % y);
                  (v = c.appendChild(elt('span', spaceStr(b), 'cm-tab'))).setAttribute(
                    'role',
                    'presentation',
                  ),
                  ...
                  '\r' == f[0] || '\n' == f[0]
                    ? ((v = c.appendChild(
                      ...
                      (e.col += 1))
                    : ((v = e.cm.options.specialCharPlaceholder(f[0])).setAttribute(
                        'cm-text',
                        f[0],
                      ),
                      a && s < 9 ? c.appendChild(elt('span', [v])) : c.appendChild(v),
                      (e.col += 1));
              ...
              if (v == f) {
                ...
                for (var y = [], b = void 0, x = 0; x < r.length; ++x) {
                  ...
                  'bookmark' == w.type && C.from == f && w.widgetNode
                    ...
                    : C.from <= f &&
                      ...
                      ? (null != C.to && C.to != f && v > C.to && ((v = C.to), (c = '')),
                ...
                if (b)
                  for (var S = 0; S < b.length; S += 2)
                    b[S + 1] == v && (c += ' ' + b[S]);
                if (!p || p.from == f)
                  for (var k = 0; k < y.length; ++k) buildCollapsedSpan(t, 0, y[k]);
                if (p && (p.from || 0) == f) {
                  if (
                    (buildCollapsedSpan(
                      t,
              ...
              for (var L = Math.min(h, v); ; ) {
                if (m) {
                  ...
                  if (!p) {
                    ...
                    t.addToken(t, T, a ? a + l : l, u, f + T.length == v ? c : '', d, s);
                  }
                  if (M >= L) {
                    (m = m.slice(L - f)), (f = L);
                    break;
        ...
        function insertLineWidgetsFor(e, t, n, r, o) {
          if (t.widgets)
            for (var i = ensureLineWrapped(n), a = 0, s = t.widgets; a < s.length; ++a) {
              var l = s[a],
              ...
              l.handleMouseEvents || c.setAttribute('cm-ignore-events', 'true'),
                ...
                o && l.above ? i.insertBefore(c, n.gutter || n.text) : i.appendChild(c),
        ...
        function widgetHeight(e) {
          ...
          if (!contains(document.body, e.node)) {
            ...
            e.coverGutter &&
              ...
              removeChildrenAndAdd(t.display.measure, elt('div', [e.node], null, n));
          }
        ...
        function mapFromLineView(e, t, n) {
          ...
          for (var o = 0; o < e.rest.length; o++)
            if (lineNo(e.rest[o]) > n)
              return { map: e.measure.maps[o], cache: e.measure.caches[o], before: !0 };
        }
        function updateExternalMeasurement(e, t) {
          ...
          return (r.text = o.pre), removeChildrenAndAdd(e.display.lineMeasure, o.pre), r;
        }
        ...
        function nodeAndOffsetInLineMap(e, t, n) {
          ...
          return { node: r, start: o, end: i, collapse: a, coverStart: s, coverEnd: l };
        }
        function getUsefulRect(e, t) {
          var n = ce;
          if ('left' == t)
            for (var r = 0; r < e.length && (n = e[r]).left == n.right; r++);
          else for (var o = e.length - 1; o >= 0 && (n = e[o]).left == n.right; o--);
          return n;
        }
        function measureCharInner(e, t, n, r) {
          ...
          if (3 == l.nodeType) {
            for (var p = 0; p < 4; p++) {
              for (; c && isExtendingChar(t.line.text.charAt(i.coverStart + c)); ) --c;
              for (
                ;
          ...
          return (
            ...
            e.options.singleCursorHeightPerLine || ((w.rtop = g), (w.rbottom = m)),
            w
          );
        }
        ...
        function intoCoordSystem(e, t, n, r, o) {
          ...
          if (
            ('local' == r ? (a += paddingTop(e.display)) : (a -= e.display.viewOffset),
            'page' == r || 'window' == r)
          ) {
        ...
        function cursorCoords(e, t, n, r, o, i) {
          function get(t, a) {
            ...
            return (
              a ? (s.left = s.right) : (s.right = s.left), intoCoordSystem(e, r, s, n)
            );
          }
          (r = r || getLine(e.doc, t.line)), o || (o = prepareMeasureForLine(e, r));
        ...
        function wrappedLineExtentChar(e, t, n, r) {
          ...
          var o = intoCoordSystem(e, t, measureCharPrepared(e, n, r), 'line').top;
          return wrappedLineExtent(e, t, n, o);
        }
        ...
        function coordsCharInner(e, t, n, r, o) {
          ...
          if (u) {
            var d = (e.options.lineWrapping ? coordsBidiPartWrapped : coordsBidiPart)(
              e,
              t,
              n,
              i,
            ...
            c || (m != l && m != s) || m++,
              (h =
                0 == m
                  ...
                  : m == t.text.length
                    ? 'before'
                    : measureCharPrepared(e, i, m - (c ? 1 : 0)).bottom + a <= o == c
                      ? 'after'
                      : 'before');
            var x = cursorCoords(e, Pos(n, m, h), 'line', t, i);
            (p = x.left), (v = o < x.top || o >= x.bottom);
          }
          return (m = skipExtendingChars(t.text, m, 1)), PosWithInfo(n, m, h, v, r - p);
        }
        ...
        function textHeight(e) {
          ...
          if (null == le) {
            le = elt('pre');
            for (var t = 0; t < 49; ++t)
              le.appendChild(document.createTextNode('x')), le.appendChild(elt('br'));
            le.appendChild(document.createTextNode('x'));
          }
          removeChildrenAndAdd(e.measure, le);
          var n = le.offsetHeight / 50;
          return n > 3 && (e.cachedTextHeight = n), removeChildren(e.measure), n || 1;
        }
        ...
        function estimateHeight(e) {
          var t = textHeight(e.display),
            ...
            r =
              n &&
              Math.max(5, e.display.scroller.clientWidth / charWidth(e.display) - 3);
          return function(o) {
        ...
        function posFromMouse(e, t, n, r) {
          ...
          var l,
            c = coordsChar(e, i, a);
          if (r && 1 == c.xRel && (l = getLine(e.doc, c.line).text).length == c.ch) {
            var u = countColumn(l, l.length, e.options.tabSize) - l.length;
            c = Pos(
              c.line,
              Math.max(
                0,
                Math.round((i - paddingH(e.display).left) / charWidth(e.display)) - u,
              ),
            );
          }
          return c;
        ...
        function drawSelectionRange(e, t, n) {
          var r = e.display,
            ...
            s = a.left,
            l = Math.max(r.sizerWidth, displayWidth(e) - r.sizer.offsetLeft) - a.right,
            c = 'ltr' == o.direction;
          ...
          function drawForLine(t, n, r) {
            ...
            return (
              iterateBidiSections(p, n || 0, null == r ? d : r, function(e, t, o, u) {
                var h = 'ltr' == o,
                ...
                if (g.top - f.top <= 3) {
                  ...
                  h
                    ? ((k = c && m && y ? s : f.left),
                      ...
                      (M = c ? s : wrapX(t, o, 'after')),
                      (T = c && v && b ? l : g.right))
                    : ((k = c ? wrapX(e, o, 'before') : s),
                      (L = !c && m && y ? l : f.right),
                      (M = !c && v && b ? s : g.left),
          ...
          if (u.line == d.line) drawForLine(u.line, u.ch, d.ch);
            ...
            f &&
              (g.top < m.top - 2
                ? (add(g.right, g.top, null, g.bottom), add(s, m.top, m.left, m.bottom))
          ...
          for (
            ...
            if (!o.hidden) {
              ...
              if (
                (i < 2 && (i = textHeight(t)),
                (u > 0.005 || u < -0.005) &&
                  (updateLineHeight(o.line, i), updateWidgetHeight(o.line), o.rest))
              )
                for (var d = 0; d < o.rest.length; d++) updateWidgetHeight(o.rest[d]);
            }
          }
        }
        ...
        function alignHorizontally(e) {
          ...
          if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
            for (
              var r = compensateForHScroll(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
        ...
        function maybeUpdateLineNumberWidth(e) {
          ...
          if (n.length != r.lineNumChars) {
            ...
            return (
              ...
              (r.lineNumInnerWidth = Math.max(i, r.lineGutter.offsetWidth - a) + 1),
          ...
          null == r && (r = 0),
            e.options.lineWrapping ||
              ...
              ((t = t.ch
                ...
                : t),
              (n = 'before' == t.sticky ? Pos(t.line, t.ch + 1, 'before') : t));
          for (var i = 0; i < 5; i++) {
            var a = !1,
              s = cursorCoords(e, t),
        ...
        function calculateScrollPos(e, t) {
          ...
          var d =
            ...
            p = displayWidth(e) - (e.options.fixedGutter ? n.gutters.offsetWidth : 0),
            h = t.right - t.left > p;
          return (
            h && (t.right = t.left + p),
            t.left < 10
          ...
          (ue.prototype.enableZeroWidthBar = function(e, t, n) {
            (e.style.pointerEvents = 'auto'),
              t.set(1e3, function maybeDisable() {
                ...
                o != e ? (e.style.pointerEvents = 'none') : t.set(1e3, maybeDisable);
              });
          }),
          ...
          e.updatedDisplay && updateHeightsInViewport(t),
            ...
            n.maxLineChanged &&
              ...
              (e.barMeasure.scrollWidth = Math.max(
                ...
                n.sizer.offsetLeft + e.adjustWidthTo + scrollGap(t) + t.display.barWidth,
              )),
        ...
        function regLineChange(e, t, n) {
          ...
          if (
            (o && t >= o.lineN && t < o.lineN + o.size && (r.externalMeasured = null),
          ...
          0 == o.length || t >= r.viewTo || n <= r.viewFrom
            ...
            : (r.viewFrom > t
              ...
              r.viewTo < n
                ...
                : r.viewTo > n && (r.view = r.view.slice(0, findViewIndex(e, n)))),
            (r.viewTo = n);
        }
        ...
        function highlightWorker(e) {
          ...
          if (!(t.highlightFrontier >= e.display.viewTo)) {
            var n = +new Date() + e.options.workTime,
              ...
              o = [];
            t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(
              i,
            ) {
              if (r.line >= e.display.viewFrom) {
                ...
                i.text.length <= e.options.maxHighlightLength &&
                  ...
                  r.nextLine();
              if (+new Date() > n) return startWorker(e, e.options.workDelay), !0;
            }),
              (t.highlightFrontier = r.line),
              (t.modeFrontier = Math.max(t.modeFrontier, r.line)),
              o.length &&
                runInOp(e, function() {
                  for (var t = 0; t < o.length; t++) regLineChange(e, o[t], 'text');
                });
          }
        }
        ...
        function updateDisplayIfNeeded(e, t) {
          ...
          n.viewFrom < i && i - n.viewFrom < 20 && (i = Math.max(r.first, n.viewFrom)),
        ...
        function postUpdateDisplay(e, t) {
          for (
            ...
            ((r && e.options.lineWrapping && t.oldDisplayWidth != displayWidth(e)) ||
              (n &&
                null != n.top &&
                (n = {
                  top: Math.min(
        ...
        (ve.prototype.primary = function() {
          ...
          (ve.prototype.equals = function(e) {
            ...
            for (var t = 0; t < this.ranges.length; t++) {
              var n = this.ranges[t],
                r = e.ranges[t];
              if (!equalCursorPos(n.anchor, r.anchor) || !equalCursorPos(n.head, r.head))
                return !1;
            }
            return !0;
          }),
        ...
        function adjustForChange(e, t) {
          ...
          var n = e.line + t.text.length - (t.to.line - t.from.line) - 1,
            r = e.ch;
          return e.line == t.to.line && (r += changeEnd(t).ch - t.to.ch), Pos(n, r);
        }
        ...
        function updateDoc(e, t, n, r) {
          ...
          function linesFor(e, t) {
            for (var n = [], o = e; o < t; ++o) n.push(new re(a[o], spansFor(o), r));
            return n;
          }
          var o = t.from,
            i = t.to,
            ...
            d = i.line - o.line;
          if (t.full)
            e.insert(0, linesFor(0, a.length)), e.remove(a.length, e.size - a.length);
            ...
            update(s, s.text.slice(0, o.ch) + a[0] + l.text.slice(i.ch), spansFor(0)),
              e.remove(o.line + 1, d);
          else {
            update(s, s.text.slice(0, o.ch) + a[0], spansFor(0)),
        ...
        function attachLocalSpans(e, t, n, r) {
          ...
          e.iter(Math.max(e.first, n), Math.min(e.first + e.size, r), function(n) {
            n.markedSpans && ((o || (o = t['spans_' + e.id] = {}))[i] = n.markedSpans),
              ++i;
          });
        }
        ...
        function extendRange(e, t, n, r) {
          if (r) {
            ...
            if (n) {
              var i = cmp(t, o) < 0;
              i != cmp(n, o) < 0 ? ((o = t), (t = n)) : i != cmp(t, n) < 0 && (t = n);
            }
            return new ye(o, t);
          }
          return new ye(n || t, t);
          ...
          var r = {
            ...
            update: function(t) {
              ...
              for (var n = 0; n < t.length; n++)
                this.ranges[n] = new ye(clipPos(e, t[n].anchor), clipPos(e, t[n].head));
            },
            origin: n && n.origin,
          };
          return (
        ...
        function setSelectionNoUndo(e, t, n) {
          ...
          var r =
            (n && n.bias) || (cmp(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
          ...
          if (i.markedSpans)
            for (var a = 0; a < i.markedSpans.length; ++a) {
              var s = i.markedSpans[a],
                l = s.marker;
              if (
                (null == s.from || (l.inclusiveLeft ? s.from <= t.ch : s.from < t.ch)) &&
                ...
                if (n) {
                  ...
                  if (
                    ...
                    c && c.line == t.line && (u = cmp(c, n)) && (r < 0 ? u < 0 : u > 0))
                  )
          ...
          if (!r || n) {
            for (
              var o,
                ...
                c = 0;
              c < s.length && ((o = s[c]), n ? !o.ranges || o.equals(e.sel) : o.ranges);
              c++
            );
            if (c != s.length) {
        ...
        function makeChangeSingleDocInEditor(e, t, n) {
          ...
          t.full
            ? regChange(e)
            : i.line != a.line || 1 != t.text.length || isWholeLineUpdate(e.doc, t)
        ...
        function changeLine(e, t, n, r) {
          var o = t,
            i = t;
          return (
            'number' == typeof t ? (i = getLine(e, clipLine(e, t))) : (o = lineNo(t)),
          ...
          (LeafChunk.prototype = {
            ...
            removeInner: function(e, t) {
              for (var n = e, r = e + t; n < r; ++n) {
                var o = this.lines[n];
                (this.height -= o.height), cleanUpLine(o), signalLater(o, 'delete');
              }
              ...
              if (!(this.children.length <= 10)) {
                ...
                do {
                  ...
                  if (e.parent) {
                    ...
                    var o = new BranchChunk(e.children);
          ...
          return (
            ...
            changeLine(e, t, 'widget', function(t) {
              ...
              if (
                (null == o.insertAt
                  ? n.push(o)
                  : n.splice(Math.min(n.length - 1, Math.max(0, o.insertAt)), 0, o),
                (o.line = t),
                i && !lineIsHidden(e, t))
              ) {
        ...
        (be.prototype.clear = function() {
          ...
          if (null != r && t) {
            ...
            updateLineHeight(n, Math.max(0, n.height - i)),
              e &&
                (runInOp(e, function() {
                  adjustScrollWhenAboveVisible(e, n, -i), regLineChange(e, r, 'widget');
                }),
        ...
        function markText(e, t, n, r, o) {
          ...
          var i = new Ce(e, o),
            a = cmp(t, n);
          if ((r && copyObj(r, i, !1), a > 0 || (0 == a && !1 !== i.clearWhenEmpty)))
            return i;
          if (
            (i.replacedWith &&
              ((i.collapsed = !0),
              (i.widgetNode = eltP('span', [i.replacedWith], 'CodeMirror-widget')),
              r.handleMouseEvents ||
          ...
          i.addToHistory &&
            addChangeToHistory(e, { from: t, to: n, origin: 'markText' }, e.sel, NaN);
          var s,
            l = t.line,
            c = e.cm;
          if (
            ...
            i.atomic && reCheckSelection(c.doc), signalLater(c, 'markerAdded', c, i);
          }
          return i;
        }
        (Ce.prototype.clear = function() {
          if (!this.explicitlyCleared) {
            ...
            for (var r = null, o = null, i = 0; i < this.lines.length; ++i) {
              ...
              e && !this.collapsed
                ...
                : e &&
                  (null != s.to && (o = lineNo(a)), null != s.from && (r = lineNo(a))),
          ...
          (Ce.prototype.find = function(e, t) {
            ...
            for (var o = 0; o < this.lines.length; ++o) {
              ...
              if (null != a.from && ((n = Pos(t ? i : lineNo(i), a.from)), -1 == e))
                return n;
              if (null != a.to && ((r = Pos(t ? i : lineNo(i), a.to)), 1 == e)) return r;
            }
        ...
        (ke.prototype = createObj(BranchChunk.prototype, {
          ...
          addLineClass: docMethodOp(function(e, t, n) {
            return changeLine(this, e, 'gutter' == t ? 'gutter' : 'class', function(e) {
              var r =
                'text' == t
                  ? 'textClass'
                  : 'background' == t
        ...
        function onDrop(e) {
          var t = this;
          if (
            (clearDragCursor(t), !signalDOMEvent(t, e) && !eventInWidget(t.display, e))
          ) {
            ...
            return runInOp(e, function() {
              for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                if (t[r].empty()) {
                  ...
                  if (i)
                    if ((o.ch == i.length && (o = new Pos(o.line, o.ch - 1)), o.ch > 0))
                      ...
                      a &&
                        ((o = new Pos(o.line, 1)),
                        e.replaceRange(
                          i.charAt(0) + e.doc.lineSeparator() + a.charAt(a.length - 1),
        ...
        function dispatchKeyInner(e, t, n, r) {
          ...
          return (
            ...
            ('handled' != o && 'multi' != o) || (e_preventDefault(n), restartBlink(e)),
            !!o
          );
        }
        ...
        function onKeyPress(e) {
          ...
          if (
            ...
            if (!d || (e.which && !(e.which < 10)) || !handleKeyBinding(t, e)) {
              ...
              '\b' != o && (handleCharBinding(t, e, o) || t.display.input.onKeyPress(e));
            }
          }
        }
        var We,
        ...
        function onMouseDown(e) {
          var t = this,
            n = t.display;
          if (!(signalDOMEvent(t, e) || (n.activeTouch && n.input.supportsTouch())))
            if ((n.input.ensurePolled(), (n.shift = e.shiftKey), eventInWidget(n, e)))
              l ||
        ...
        function handleMappedButton(e, t, n, r, o) {
          var i = 'Click';
          return (
            'double' == r ? (i = 'Double' + i) : 'triple' == r && (i = 'Triple' + i),
            dispatchKey(
              e,
              addModifierNames(
        ...
        function leftButtonSelect(e, t, n, r) {
          ...
          if (
            ...
            r.addNew || (a = new ye(n, n)), (n = posFromMouse(e, t, !0, !0)), (s = -1);
          else {
        ...
        function bidiSimplify(e, t) {
          ...
          var p = i[c + (l ? -1 : 0)],
            ...
            f = h ? p.from : p.to,
            g = h ? 'after' : 'before';
          return n.ch == f && n.sticky == g ? t : new ye(new Pos(n.line, f, g), r);
        }
        function gutterEvent(e, t, n, r) {
          ...
          for (var l = 0; l < e.options.gutters.length; ++l) {
            ...
            if (c && c.getBoundingClientRect().right >= o) {
              var u = lineAtHeight(e.doc, i),
                d = e.options.gutters[l];
              return signal(e, n, e, u, d, t), e_defaultPrevented(t);
            }
          }
        }
        ...
        function CodeMirror$1(e, t) {
          ...
          Me || (registerGlobalHandlers(), (Me = !0)),
          startOperation(this),
          ...
          (t.autofocus && !v) || this.hasFocus()
            ...
            : onBlur(this),
          Re))
            Re.hasOwnProperty(c) && Re[c](n, t[c], Be);
          maybeUpdateLineNumberWidth(this), t.finishInit && t.finishInit(this);
          for (var u = 0; u < Ve.length; ++u) Ve[u](n);
          endOperation(this),
            l &&
              t.lineWrapping &&
              ...
              a && s < 11
                ? operation(e, function(t) {
                    if (!signalDOMEvent(e, t)) {
                      var n = posFromMouse(e, t);
                      if (n && !clickInGutter(e, t) && !eventInWidget(e.display, t)) {
                        e_preventDefault(t);
                ...
                (o =
                  !r.prev || farAway(r, r.prev)
                    ...
                    : !r.prev.prev || farAway(r, r.prev.prev)
                      ? e.findWordAt(i)
                      : new ye(Pos(i.line, 0), clipPos(e.doc, Pos(i.line + 1, 0)))),
        ...
        function indentLine(e, t, n, r) {
          ...
          if (r || /\S/.test(s.text)) {
            if (
              'smart' == n &&
              ((c = i.mode.indent(o, s.text.slice(u.length), s.text)) == P || c > 150)
            ) {
              if (!r) return;
              n = 'prev';
            }
        ...
        function triggerElectric(e, t) {
          if (e.options.electricChars && e.options.smartIndent)
            for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
              var o = n.ranges[r];
              if (
                !(o.head.ch > 100 || (r && n.ranges[r - 1].head.line == o.head.line))
              ) {
        ...
        function findPosH(e, t, n, r, o) {
          ...
          function moveOnce(r) {
            var i, a;
            if (null == (i = o ? moveVisually(e.cm, s, t, n) : moveLogically(s, t, n))) {
              if (
                r ||
                ((a = t.line + n) < e.first ||
                  a >= e.first + e.size ||
        ...
        function posToDOM(e, t) {
          ...
          var r = getLine(e.doc, t.line),
            ...
            a = 'left';
          if (i) {
            var s = getBidiPartAt(i, t.ch);
            a = s % 2 ? 'right' : 'left';
          }
          var l = nodeAndOffsetInLineMap(o.map, t.ch, a);
        ...
        function domTextBetween(e, t, n, r, o) {
          ...
          function walk(t) {
            if (1 == t.nodeType) {
              ...
              3 == t.nodeType &&
                addText(t.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
            var h;
          }
        ...
        function locateNodeInLineView(e, t, n) {
          ...
          for (
            ...
            if ((u = find(d, d.firstChild, 0))) return badPos(Pos(u.line, u.ch - p), o);
            p += d.textContent.length;
          }
          for (var h = s.previousSibling, f = n; h; h = h.previousSibling) {
            if ((u = find(h, h.firstChild, -1))) return badPos(Pos(u.line, u.ch + f), o);
        ...
        (je.prototype.init = function(e) {
          ...
          (je.prototype.pollSelection = function() {
            if (
              ...
              var e = this.getSelection(),
                t = this.cm;
              if (m && u && this.cm.options.gutters.length && isInGutter(e.anchorNode))
                return (
          ...
          (je.prototype.pollContent = function() {
            ...
            a.line == o.viewFrom || 0 == (e = findViewIndex(r, a.line))
              ...
              : ((t = lineNo(o.view[e].line)), (n = o.view[e - 1].node.nextSibling));
            var l,
              c,
            ...
            for (
              var d = r.doc.splitLines(domTextBetween(r, n, c, t, l)),
                p = getBetween(r.doc, Pos(t, 0), Pos(l, getLine(r.doc, l).text.length));
            ...
            for (
              var h = 0, f = 0, g = d[0], m = p[0], v = Math.min(g.length, m.length);
            ...
            for (
              ...
              f < x && y.charCodeAt(y.length - f - 1) == b.charCodeAt(b.length - f - 1);
          ...
          (Ge.prototype.onContextMenu = function(e) {
            ...
            if (i && !d) {
              ...
              if (
                ...
                e_stop(e);
                var m = function() {
                  off(window, 'mouseup', m), setTimeout(rehide, 20);
                };
                V(window, 'mouseup', m);
              ...
              option('lineSeparator', null, function(e, t) {
                if (((e.doc.lineSep = t), t)) {
                  ...
                  for (var o = n.length - 1; o >= 0; o--)
                    replaceRange(e.doc, t, n[o], Pos(n[o].line, n[o].ch + t.length));
                }
              }),
              option(
                'specialChars',
            ...
            (e.prototype = {
              ...
              removeOverlay: methodOp(function(e) {
                for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                  ...
                  if (r == e || ('string' == typeof e && r.name == e))
                    return t.splice(n, 1), this.state.modeGen++, void regChange(this);
                }
              }),
              ...
              findWordAt: function(e) {
                ...
                if (n) {
                  ...
                  ('before' != e.sticky && o != n.length) || !r ? ++o : --r;
                  for (
                    var a = n.charAt(r),
                      s = isWordChar(a, i)
                        ? function(e) {
                ...
                return new ye(Pos(e.line, r), Pos(e.line, o));
              },
              toggleOverwrite: function(e) {
              ...
              (e.registerHelper = function(t, r, o) {
                n.hasOwnProperty(t) || (n[t] = e[t] = { _global: [] }), (n[t][r] = o);
              }),
        ...
        return (
          ...
          (CodeMirror$1.fromTextArea = function fromTextArea(e, t) {
            ...
            var r;
            if (e.form && (V(e.form, 'submit', save), !t.leaveSubmitMethodAlone)) {
              var o = e.form;
              r = o.submit;
              try {
              ...
              (Controlled.prototype.componentWillReceiveProps = function(e) {
                if (!c) {
                  ...
                  e.value !== this.props.value && (this.hydrated = !1),
                    ...
                    this.hydrate(e),
                    this.appliedNext ||
                      (this.shared.applyNext(this.props, e, t), (this.appliedNext = !0)),
                    this.shared.applyUserDefined(this.props, t),
                    (this.appliedUserDefined = !0);
                }
              }),
              (Controlled.prototype.componentWillUnmount = function() {
                c || (this.props.editorWillUnmount && this.props.editorWillUnmount(s));
              }),
            ...
            (UnControlled.prototype.componentWillReceiveProps = function(e) {
              if (
                (this.detached &&
                  !1 === e.detach &&
                  ((this.detached = !1),
                  this.props.editorDidAttach && this.props.editorDidAttach(this.editor)),
                this.detached ||
                  !0 !== e.detach ||
                  ((this.detached = !0),
                  this.props.editorDidDetach && this.props.editorDidDetach(this.editor)),
                !c && !this.detached)
              ) {
                var t = { cursor: null };
        ...
        e.defineMode(
          ...
          function(t, n) {
            ...
            function xmlToken(n, i, a) {
              if (2 == a.depth)
                return n.match(/^.*?\*\//) ? (a.depth = 1) : n.skipToEnd(), 'comment';
              if ('{' == n.peek()) {
                ...
                return (
                  (i.context = new Context(e.startState(o, s), o, 0, i.context)), null
                );
              }
              if (1 == a.depth) {
                if ('<' == n.peek())
        ...
        e.defineMode('xml', function(r, o) {
          ...
          function doctype(e) {
            return function(t, n) {
              for (var r; null != (r = t.next()); ) {
                if ('<' == r) return (n.tokenize = doctype(e + 1)), n.tokenize(t, n);
                if ('>' == r) {
                  if (1 == e) {
                    n.tokenize = inText;
                    break;
          ...
          function Context(e, t, n) {
            (this.prev = e.context),
              ...
              (this.startOfLine = n),
              (l.doNotIndent.hasOwnProperty(t) || (e.context && e.context.noIndent)) &&
                (this.noIndent = !0);
          }
          ...
          return (
            (inText.isInText = !0),
            {
              ...
              token: function(e, t) {
                if (
                  (!t.tagName && e.sol() && (t.indented = e.indentation()), e.eatSpace())
                )
                  return null;
                i = null;
        ...
        e.defineMode('javascript', function(t, n) {
              ...
              return (
                ...
                function(e, t) {
                  ...
                  if (s && '@' == e.peek() && e.match(h))
                    return (t.tokenize = tokenBase), ret('jsonld-keyword', 'meta');
                  for (; null != (r = e.next()) && (r != n || o); ) o = !o && '\\' == r;
          ...
          function parseJS(e, t, n, r, o) {
            ...
            for (
              ...
              var a = i.length ? i.pop() : l ? expression : statement;
              if (a(n, r)) {
          ...
          function pushcontext() {
            (m.state.context = new Context(m.state.context, m.state.localVars, !1)),
              (m.state.localVars = v);
          }
          function pushblockcontext() {
            (m.state.context = new Context(m.state.context, m.state.localVars, !0)),
            ...
            var n = function() {
              ...
              if ('stat' == n.lexical.type) r = n.lexical.indented;
                ...
                for (var o = n.lexical; o && ')' == o.type && o.align; o = o.prev)
                  r = o.indented;
              n.lexical = new JSLexical(r, m.stream.column(), e, null, n.lexical, t);
            };
            return (n.lex = !0), n;
          }
          function poplex() {
          ...
          function continueQuasi(e) {
            if ('}' == e)
              return (
                (m.marked = 'string-2'), (m.state.tokenize = tokenQuasi), cont(quasi)
              );
          }
          function arrowBody(e) {
            return (
              findFatArrow(m.stream, m.state), pass('{' == e ? statement : expression)
            );
          }
          ...
          function maybeTarget(e) {
            return function(t) {
              return '.' == t
                ...
                : 'variable' == t && c
                  ? cont(maybeTypeArgs, e ? maybeoperatorNoComma : maybeoperatorComma)
                  : pass(e ? expressionNoComma : expression);
            };
          }
          function target(e, t) {
            if ('target' == t) return (m.marked = 'keyword'), cont(maybeoperatorComma);
          }
          function targetNoComma(e, t) {
            if ('target' == t) return (m.marked = 'keyword'), cont(maybeoperatorNoComma);
          }
          ...
          function classBody(e, t) {
            return 'async' == e ||
              ('variable' == e &&
                ('static' == t || 'get' == t || 'set' == t || (c && isModifier(t))) &&
      ...
      var h = 10,
        f = (function(e) {
          function Editor() {
            ...
            return (e.handleChange = c()(e.handleChange.bind(e), h)), e;
          }
          return (
            ...
            p(Editor, [
              {
                ...
                value: function shouldComponentUpdate(e) {
                  return !(
                    !this.getEditorConfig(e).readOnly || e.code === this.props.code
                  );
                },
              },
              {
